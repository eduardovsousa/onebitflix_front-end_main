    ...
    return <>
        <Head>
            ...
            <main className={ styles.main }>
                <HeaderGenric logoUrl="/" btnUrl="/register" btnContent="Quero fazer parte"/>
            ...
            <Container className="py-5">
                ...
                <Form className={ styles.form } onSubmit={ handleLogin }>
                    ...
                    <FormGroup>
                        ...
                        <Input id="email" name="email" type="email" placeholder="Qual o seu e-mail?" required className={ styles.input }></Input>
                    </FormGroup>
                    <FormGroup>
